...
def wash_data():
    HomeLoansApproval = pd.read_csv(r"D:\Home_Loan_prediction\loan_sanction_train.csv")
...
def page_plot_box():
    ...
    st.markdown('# ***SEE WHERE YOU ARE AT :***')
...
def plot_pie_chart():
    ...
    df_selected = pd.read_csv(r"D:\Home_Loan_prediction\loan_sanction_train.csv")
